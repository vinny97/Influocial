...
<html lang="en">
  <head>
    ...
    <title>Contact Us | Influocial</title>
  </head>
  <body>
    ...
    <main>
      <?php
        if(isset($_POST["submit"])) {
          ...
          $toSubject = "Contact Form from Contact Us";
          $toContent = "Company: " . $company . "\nCountry: " . $country . "\nSubject: " . $subject . "\nMessage: " . $message;
          $toEmail = "info@influocial.co.uk";
          $mailHeaders = "From: " . $name . "<". $email .">\r\n";

          $conn = mysqli_connect("localhost", "influoci_influocial", "Clb#2021", "influoci_influocial");
          if($conn) {
            $query = "SELECT count(*) as allcount FROM contact WHERE name='".$name."' && email='".$email."' && company='".$company."' && country='".$country."' && subject='".$subject."' && message='".$message."'";
            ...
            if($allcount > 0){
              ...
              mysqli_query($conn, "INSERT INTO contact (name, email, company, country, subject, message) VALUES ('" . $name. "','" . $email. "', '" . $company. "','" . $country. "','" . $subject. "','" . $message. "')");
              $insert_id = mysqli_insert_id($conn);
              if(mail($toEmail, $toSubject, $toContent, $mailHeaders) && !empty($insert_id)) {
                echo '
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-12 col-sm-10 col-md-8 col-lg-7 col-xl-6 col-xxl-5">
              <div class="text-center fadeUp">
                <h3 class="subheading">Got a Question?</h3>
                <h2 class="heading__underline heading__underline--blue">Contact Us!</h2>
                <p>We’re here to help and answer any question you might have. We look forward to hearing from you.</p>
              </div>
            </div>
            <div class="w-100"></div>
            <div class="col-12 col-sm-10 col-md-8 col-lg-7 col-xl-6 col-xxl-5">
              <form class="px-3 py-5" action="" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <label for="company" class="form-label">Business/Company Name*</label>
                  <input type="company" name="company" class="form-control form-control-lg" id="company" required maxlength="50">
                </div>
                <div class="mb-3">
